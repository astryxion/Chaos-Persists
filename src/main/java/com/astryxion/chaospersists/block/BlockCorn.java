...
public class BlockCorn extends SugarCaneBlock {
...
public RenderType getRenderType(BlockState state) {
    ...
    public boolean canSurvive(BlockState state, IWorldReader world, BlockPos pos) {
        ...
        return bid == ChaosPersists.MyCornPlant1 || bid == ChaosPersists.MyCornPlant2
                || bid == ChaosPersists.MyCornPlant3 || bid == ChaosPersists.MyCornPlant4
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random rand) {
        ...
        if (world.getBlockState(new BlockPos(par2, par3 + 1, par4)).getBlock() == Blocks.AIR) {
            for (int var6 = 1; var6 < 10 && ((bid = world.getBlockState(new BlockPos(par2, par3 - var6, par4)).getBlock()) == ChaosPersists.MyCornPlant1 || bid == ChaosPersists.MyCornPlant2 || bid == ChaosPersists.MyCornPlant3 || bid == ChaosPersists.MyCornPlant4); ++var6) {
                ++height;
            ...
            if (var7 >= 6 - this.myMaxHeight / 3) {
                if (height < this.myMaxHeight) {
                    world.setBlock(new BlockPos(par2, par3 + 1, par4), ChaosPersists.MyCornPlant1.defaultBlockState(), 2);
                    world.setBlock(new BlockPos(par2, par3, par4), ChaosPersists.MyCornPlant2.defaultBlockState(), 2);
                } else {
                    for (int i = 1; i < this.myMaxHeight - 1; ++i) {
                        ...
                        if (bid == ChaosPersists.MyCornPlant2) {
                            world.setBlock(new BlockPos(par2, par3 - i, par4), ChaosPersists.MyCornPlant3.defaultBlockState(), 2);
                            continue;
                        }
                        if (bid != ChaosPersists.MyCornPlant3) {
                            continue;
                        }
                        world.setBlock(new BlockPos(par2, par3 - i, par4), ChaosPersists.MyCornPlant4.defaultBlockState(), 2);
                    }
    ...
    public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
        ...
        if (this == ChaosPersists.MyCornPlant4) {
            ...
            return Collections.singletonList(new ItemStack(ChaosPersists.MyCornCob, 1 + rand.nextInt(2)));
        }
