...
public class BlockCrystalTreeLog extends Block {

    public BlockCrystalTreeLog() {
        this(0.2F);
    }

    public BlockCrystalTreeLog(float hardness) {
    ...
    public ItemStack getCloneItemStack(IBlockReader world, BlockPos pos, BlockState state) {
        return new ItemStack(ChaosPersists.MyCrystalTreeLog);
    }
        ...
        for (int var9 = -var7; var9 <= var7; ++var9) {
            for (int var10 = -var7; var10 <= var7; ++var10) {
                for (int var11 = -var7; var11 <= var7; ++var11) {
                    ...
                    popResource((ServerWorld) world, p, new ItemStack(ChaosPersists.MyCrystalTreeLog));
