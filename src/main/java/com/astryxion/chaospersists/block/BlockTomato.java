...
public class BlockTomato extends SugarCaneBlock {
...
public RenderType getRenderType(BlockState state) {
    ...
    public boolean canSurvive(BlockState state, IWorldReader world, BlockPos pos) {
        ...
        return bid == ChaosPersists.MyTomatoPlant1 || bid == ChaosPersists.MyTomatoPlant2
                || bid == ChaosPersists.MyTomatoPlant3 || bid == ChaosPersists.MyTomatoPlant4
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random rand) {
        ...
        if (world.getBlockState(new BlockPos(par2, par3 + 1, par4)).getBlock() == Blocks.AIR) {
            for (int var6 = 1; var6 < 10 && ((bid = world.getBlockState(new BlockPos(par2, par3 - var6, par4)).getBlock()) == ChaosPersists.MyTomatoPlant1 || bid == ChaosPersists.MyTomatoPlant2 || bid == ChaosPersists.MyTomatoPlant3 || bid == ChaosPersists.MyTomatoPlant4); ++var6) {
                ++height;
            ...
            if (var7 >= 6 - this.myMaxHeight / 3) {
                if (height < this.myMaxHeight) {
                    world.setBlock(new BlockPos(par2, par3 + 1, par4), ChaosPersists.MyTomatoPlant1.defaultBlockState(), 2);
                    world.setBlock(new BlockPos(par2, par3, par4), ChaosPersists.MyTomatoPlant2.defaultBlockState(), 2);
                } else {
                    for (int i = 1; i < this.myMaxHeight - 1; ++i) {
                        ...
                        if (bid == ChaosPersists.MyTomatoPlant2) {
                            world.setBlock(new BlockPos(par2, par3 - i, par4), ChaosPersists.MyTomatoPlant3.defaultBlockState(), 2);
                            continue;
                        }
                        if (bid != ChaosPersists.MyTomatoPlant3) {
                            continue;
                        }
                        world.setBlock(new BlockPos(par2, par3 - i, par4), ChaosPersists.MyTomatoPlant4.defaultBlockState(), 2);
                    }
    ...
    public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
        ...
        if (this == ChaosPersists.MyTomatoPlant4) {
            ...
            return Collections.singletonList(new ItemStack(ChaosPersists.MyTomato, 1 + rand.nextInt(2)));
        }
