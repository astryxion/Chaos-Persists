...
implements IRangedAttackMob {
    ...
    private static final DataParameter<Integer> WHICH_GUY = EntityDataManager.defineId(Boyfriend.class, DataSerializers.INT);
    private static final DataParameter<Integer> VOICE = EntityDataManager.defineId(Boyfriend.class, DataSerializers.INT);
    private static final DataParameter<Integer> WHICH_WET_GUY = EntityDataManager.defineId(Boyfriend.class, DataSerializers.INT);
    private static final DataParameter<Integer> VOICE_ENABLE = EntityDataManager.defineId(Boyfriend.class, DataSerializers.INT);
    private static final DataParameter<Integer> IS_PRINCE = EntityDataManager.defineId(Boyfriend.class, DataSerializers.INT);
    private static final EquipmentSlotType[] BOYFRIEND_STRIP_SLOTS = new EquipmentSlotType[]{
        EquipmentSlotType.MAINHAND, EquipmentSlotType.FEET, EquipmentSlotType.LEGS, EquipmentSlotType.CHEST, EquipmentSlotType.HEAD, EquipmentSlotType.OFFHAND
    };
    ...
    public Boyfriend(EntityType<? extends Boyfriend> type, World par1World) {
        ...
        this.goalSelector.addGoal(2, new TemptGoal(this, 1.25, net.minecraft.item.crafting.Ingredient.of(Items.COOKED_BEEF), false));
        ...
        if (ChaosPersists.PlayNicely == 0) {
            this.targetSelector.addGoal(2, new MyEntityAINearestAttackableTarget((MobEntity)this, CreeperEntity.class, 20.0f, 0, true, true, com.google.common.base.Predicates.alwaysTrue()));
        }
        if (ChaosPersists.PlayNicely == 0) {
            this.targetSelector.addGoal(3, new MyEntityAINearestAttackableTarget((MobEntity)this, LivingEntity.class, 15.0f, 0, true, true, com.google.common.base.Predicates.alwaysTrue()));
        }
        if (ChaosPersists.PlayNicely == 0) {
            this.targetSelector.addGoal(4, new MyEntityAIJealousy((TameableEntity)this, Boyfriend.class, 6.0f, 5, true));
        }
        if (ChaosPersists.PlayNicely == 0) {
            this.targetSelector.addGoal(5, new MyEntityAIJealousy((TameableEntity)this, Boyfriend.class, 3.0f, 15, true));
        }
        this.xpReward = 0;
    }
    ...
    public void tick() {
        ...
        if (this.force_sync <= 0) {
            ...
            if (!this.level.isClientSide) {
                ...
                this.is_prince = this.entityData.get(IS_PRINCE).intValue();
            }
        }
    }
    ...
    public void addAdditionalSaveData(CompoundNBT par1CompoundNBT) {
        ...
        par1CompoundNBT.putInt("IsPrince", this.entityData.get(IS_PRINCE).intValue());
    }

    public void readAdditionalSaveData(CompoundNBT par1CompoundNBT) {
        super.readAdditionalSaveData(par1CompoundNBT);
        this.which_guy = par1CompoundNBT.getInt("GirlType");
        this.setTameSkin(this.which_guy);
        this.which_wet_guy = par1CompoundNBT.getInt("WetGirlType");
        ...
        this.entityData.set(VOICE_ENABLE, this.voice_enable);
        this.is_prince = par1CompoundNBT.getInt("IsPrince");
        this.entityData.set(IS_PRINCE, this.is_prince);
    }
    ...
    protected void customServerAiStep() {
        ...
        if (stack != null && !this.isOrderedToSit()) {
            if (victim != null) {
                if (victim instanceof LivingEntity && this.getItemInHand(net.minecraft.util.Hand.MAIN_HAND) != null) {
                    if (this.distanceTo(victim) < 4.0f || stack.getItem() == ChaosPersists.MyBertha && this.distanceTo(victim) < 10.0f) {
                        ...
                        if (this.attackTime <= 0) {
                            ...
                            if (this.fight_sound_ticker <= 0) {
                                if (!this.level.isClientSide && this.voice_enable != 0) {
                                    this.playSound(net.minecraft.util.registry.Registry.SOUND_EVENT.get(new ResourceLocation("chaospersists", "b_fight")), 0.5f, this.getVoicePitch());
                                }
                        ...
                        if (this.taunt_sound_ticker <= 0) {
                            if (!this.level.isClientSide && this.voice_enable != 0) {
                                this.playSound(net.minecraft.util.registry.Registry.SOUND_EVENT.get(new ResourceLocation("chaospersists", "b_taunt")), 0.5f, this.getVoicePitch());
                            }
                ...
                if (this.had_target != 0) {
                    this.had_target = 0;
                    if (!this.level.isClientSide && this.voice_enable != 0) {
                        this.playSound(net.minecraft.util.registry.Registry.SOUND_EVENT.get(new ResourceLocation("chaospersists", "b_woohoo")), 0.4f, this.getVoicePitch());
                    }
                }
            }
        }
    ...
    public int getTameSkin() {
        return this.entityData.get(WHICH_GUY).intValue();
    }
    ...
    public int getWetTameSkin() {
        return this.entityData.get(WHICH_WET_GUY).intValue();
    }
    ...
    public ActionResultType mobInteract(PlayerEntity par1PlayerEntityEntity, Hand hand) {
        ...
        if (this.interact(par1PlayerEntityEntity)) {
    ...
    public boolean interact(PlayerEntity par1PlayerEntityEntity) {
        ...
        if (var2 != null && (var2.getItem() == Items.COOKED_BEEF || var2.getItem() == ChaosPersists.MyPeacock) && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 16.0) {
            if (!this.isTame()) {
                if (!this.level.isClientSide) {
        ...
        if (this.isTame() && var2 != null && var2.getItem() == Item.byBlock((Block)Blocks.DEAD_BUSH) && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 16.0 && this.isOwnedBy(par1PlayerEntityEntity)) {
            if (!this.level.isClientSide) {
                this.setTame(false);
        ...
        if (this.isTame() && var2 != null && var2.getItem() == ChaosPersists.MyRuby && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 16.0 && this.isOwnedBy(par1PlayerEntityEntity)) {
            if (!this.level.isClientSide) {
                this.voice_enable = 0;
                this.entityData.set(VOICE_ENABLE, this.voice_enable);
                this.level.broadcastEntityEvent(this, (byte)7);
        ...
        if (this.isTame() && var2 != null && var2.getItem() == ChaosPersists.MyAmethyst && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 16.0 && this.isOwnedBy(par1PlayerEntityEntity)) {
            if (!this.level.isClientSide) {
                this.voice_enable = 1;
                this.entityData.set(VOICE_ENABLE, this.voice_enable);
                this.level.broadcastEntityEvent(this, (byte)7);
        ...
        if (this.isTame() && var2 != null && (var2.getItem() == Items.LEATHER || var2.getItem() == ChaosPersists.MyPeacockFeather) && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 16.0 && this.isOwnedBy(par1PlayerEntityEntity)) {
            if (!this.level.isClientSide) {
        ...
        if (this.isTame() && var2 != null && this.isOwnedBy(par1PlayerEntityEntity) && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 16.0) {
            if (var2.isEdible()) {
                if (!this.level.isClientSide) {
                    if ((float)this.mygetMaxHealth() > this.getHealth()) {
        ...
        if (this.isTame() && var2 == null && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 16.0 && this.isOwnedBy(par1PlayerEntityEntity)) {
            EquipmentSlotType slotToStrip = null;
            ItemStack toGive = ItemStack.EMPTY;
            for (EquipmentSlotType s : BOYFRIEND_STRIP_SLOTS) {
    ...
    protected net.minecraft.util.SoundEvent getAmbientSound() {
        ...
        if (ChaosPersists.bro_mode != 0 && this.level.random.nextInt(2) == 1) {
            return null;
        }
        if (this.level.random.nextInt(11) == 1) {
            ...
            if (this.level.random.nextInt(4) != 0) {
                ...
                if (this.level.isNight() && this.level.canSeeSky(this.blockPosition())) {
                    if (this.level.random.nextInt(3) == 0) {
    ...
    protected net.minecraft.util.SoundEvent getDeathSound() {
        ...
        return this.isTame() ? com.astryxion.chaospersists.core.ChaosSounds.B_DEATH_BOYFRIEND : com.astryxion.chaospersists.core.ChaosSounds.B_DEATH_SINGLE;
    }
    ...
    protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHit) {
        ...
        var3 = this.level.random.nextInt(26) + 10;
        ...
        if (this.isTame()) {
            ...
            if ((var5 = this.getItemBySlot(net.minecraft.inventory.EquipmentSlotType.OFFHAND)) != null && var5.getCount() > 0) {
                this.spawnAtLocation(var5.getItem(), var5.getCount());
            }
            if ((var5 = this.getItemBySlot(net.minecraft.inventory.EquipmentSlotType.FEET)) != null && var5.getCount() > 0) {
                this.spawnAtLocation(var5.getItem(), var5.getCount());
            }
            if ((var5 = this.getItemBySlot(net.minecraft.inventory.EquipmentSlotType.LEGS)) != null && var5.getCount() > 0) {
                this.spawnAtLocation(var5.getItem(), var5.getCount());
            }
            if ((var5 = this.getItemBySlot(net.minecraft.inventory.EquipmentSlotType.CHEST)) != null && var5.getCount() > 0) {
                this.spawnAtLocation(var5.getItem(), var5.getCount());
            }
        }
    }
    ...
    public void performRangedAttack(LivingEntity par1Mob) {
        ...
        if (it != null && it.getItem() == ChaosPersists.MyUltimateBow) {
            ...
            Shoes.shootTowardTarget(this, par1Mob, 6);
        }
        this.swing(Hand.MAIN_HAND);
    }

    public ItemStack getCurrentEquippedItem() {
        return this.getItemBySlot(net.minecraft.inventory.EquipmentSlotType.MAINHAND);
    }
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (!par1DamageSource.getMsgId().equals("cactus")) {
            ...
            if (!this.level.isClientSide && ret && this.hurtTime > prevHurtTime) {
                net.minecraft.entity.Entity src = par1DamageSource.getEntity();
                if (src instanceof LivingEntity && src != this) {
                    Shoes.shootTowardTarget(this, (LivingEntity) src, 6);
                }
            }
        }
        return ret;
