...
extends TameableEntity {
    ...
    public Camarasaurus(EntityType<? extends Camarasaurus> type, World par1World) {
        ...
        this.goalSelector.addGoal(3, new AvoidEntityGoal((CreatureEntity)this, MonsterEntity.class, 8.0f, 1.0, 1.399999976158142));
    ...
    private boolean isEdiblePlantBlock(Block bid) {
        return bid instanceof LeavesBlock || bid == Blocks.VINE || bid == Blocks.GRASS_BLOCK || bid == Blocks.CACTUS || bid instanceof TallGrassBlock || bid instanceof FlowerBlock || bid instanceof DoublePlantBlock;
    }
    ...
    protected void customServerAiStep() {
        ...
        if (!this.isOrderedToSit() && (this.level.random.nextInt(20) == 0 && this.getCamarasaurusHealth() < this.mygetMaxHealth() || this.level.random.nextInt(250) == 0) && ChaosPersists.PlayNicely == 0) {
            this.closest = 99999;
            this.tz = 0;
            this.ty = 0;
            this.tx = 0;
            ...
            if (this.closest < 99999) {
                ...
                if (this.closest < 12) {
                    ...
                    this.heal(1.0f);
                    this.playSound(net.minecraft.util.SoundEvents.PLAYER_BURP, 1.0f, this.level.random.nextFloat() * 0.2f + 0.9f);
                }
            }
        }
    }
