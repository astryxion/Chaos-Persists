...
public class Dragonfly extends AmbientCreature {
    ...
    protected SoundEvent getAmbientSound() {
        return ChaosSounds.DRAGONFLY_LIVING;
    }
    ...
    protected SoundEvent getDeathSound() {
        return ChaosSounds.DRAGONFLY_DEATH;
    }
    ...
    public boolean canSeeTarget(double pX, double pY, double pZ) {
        Vec3 from = new Vec3(this.getX(), this.getY() + 0.25, this.getZ());
        ...
        if (this.getRandom().nextInt(300) == 0
            ...
            while (bid.getBlock() != Blocks.AIR && keep_trying != 0) {
                ...
                this.currentFlightTarget =
                        new BlockPos((int) this.getX() + xdir, (int) this.getY() + this.getRandom().nextInt(5) - 2, (int) this.getZ() + zdir);
    ...
    public static boolean checkDragonflySpawnRules(
            EntityType<Dragonfly> type,
    ...
    private boolean isSuitableTarget(LivingEntity par1EntityLiving, boolean par2) {
        ...
        if (par1EntityLiving instanceof AbstractHorse && ChaosPersists.DragonflyHorseFriendly == 0) {
            return true;
        }
        return false;
    }
