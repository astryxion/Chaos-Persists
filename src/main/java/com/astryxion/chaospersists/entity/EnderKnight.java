...
extends MonsterEntity {
    private static final DataParameter<Byte> SCREAMING = EntityDataManager.defineId(EnderKnight.class, DataSerializers.BYTE);
    ...
    public EnderKnight(EntityType<? extends EnderKnight> type, World par1World) {
    ...
    public static AttributeModifierMap createAttributes() {
        return MonsterEntity.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, ChaosPersists.EnderKnight_stats.health)
                .add(Attributes.MOVEMENT_SPEED, 0.32)
                .add(Attributes.ATTACK_DAMAGE, ChaosPersists.EnderKnight_stats.attack)
                .build();
    }
    ...
    protected Entity findPlayerEntityToAttack() {
        ...
        PlayerEntity entityplayer = this.level.getNearestPlayer(this, 64.0);
    ...
    protected boolean attemptTeleportTo(double par1, double par3, double par5) {
        ...
        for (int lx = 0; lx < short1; ++lx) {
            ...
            if (this.level.isClientSide) {
                this.level.addParticle(net.minecraft.particles.ParticleTypes.PORTAL, d7, d8, d9, (double)pf, (double)f1, (double)f2);
            }
        }
