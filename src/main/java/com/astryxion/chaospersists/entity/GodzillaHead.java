...
public class GodzillaHead extends MobEntity {
    ...
    public GodzillaHead(EntityType<? extends GodzillaHead> type, World par1World) {
        super(type, par1World);
        // EntityType registration: width=9.9f, height=10.0f
        this.noPhysics = true;
    }
    ...
    public boolean hurt(DamageSource par1DamageSource, float par2) {
        ...
        List<Godzilla> var5 = this.level.getEntitiesOfClass(Godzilla.class, this.getBoundingBox().inflate(32.0, 32.0, 32.0));
        Iterator<Godzilla> var2 = var5.iterator();
        Godzilla var4 = null;
        if (var2.hasNext()) {
            var4 = var2.next();
    ...
    public void tick() {
        ...
        if (this.level.isClientSide) {
            ...
            if (var2.hasNext()) {
                var4 = var2.next();
                this.setPos(var4.getX() - 17.0 * Math.sin(Math.toRadians(var4.yHeadRot)), var4.getY() + 16.0, var4.getZ() + 17.0 * Math.cos(Math.toRadians(var4.yHeadRot)));
                this.yRot = var4.yRot;
