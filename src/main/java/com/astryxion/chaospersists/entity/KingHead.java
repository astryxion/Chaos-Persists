...
public class KingHead extends MobEntity {
    ...
    public KingHead(EntityType<? extends KingHead> type, World par1World) {
    ...
    public boolean hurt(DamageSource par1DamageSource, float par2) {
        ...
        List<TheKing> var5 = this.level.getEntitiesOfClass(TheKing.class, this.getBoundingBox().inflate(48.0, 32.0, 48.0));
        Iterator<TheKing> var2 = var5.iterator();
        TheKing var4 = null;
        if (var2.hasNext()) {
            var4 = var2.next();
    ...
    public void tick() {
        ...
        if (this.level.isClientSide) {
            ...
            List<TheKing> var5 = this.level.getEntitiesOfClass(TheKing.class, this.getBoundingBox().inflate(32.0, 32.0, 32.0));
            Iterator<TheKing> var2 = var5.iterator();
            TheKing var4 = null;
            if (var2.hasNext()) {
                var4 = var2.next();
