...
extends MonsterEntity {
    private static final DataParameter<Byte> ATTACKING = EntityDataManager.defineId(Pointysaurus.class, DataSerializers.BYTE);
    private GenericTargetSorter TargetSorter = null;
    private float moveSpeed = 0.35f;
    private LivingEntity rt = null;

    public Pointysaurus(EntityType<? extends Pointysaurus> type, World par1World) {
    ...
    public static AttributeModifierMap createAttributes() {
        return MonsterEntity.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, ChaosPersists.Pointysaurus_stats.health)
                .add(Attributes.MOVEMENT_SPEED, 0.35)
                .add(Attributes.ATTACK_DAMAGE, ChaosPersists.Pointysaurus_stats.attack)
                .build();
    }
    ...
    public int mygetMaxHealth() {
        return ChaosPersists.Pointysaurus_stats.health;
    }

    public int getArmorValue() {
        return ChaosPersists.Pointysaurus_stats.defense;
    }
    ...
    private void dropItemRand(Item index, int par1) {
        ItemEntity var3 = new ItemEntity(this.level, this.getX() + (double)ChaosPersists.ChaosRand.nextInt(4) - (double)ChaosPersists.ChaosRand.nextInt(4), this.getY() + 2.0, this.getZ() + (double)ChaosPersists.ChaosRand.nextInt(4) - (double)ChaosPersists.ChaosRand.nextInt(4), new ItemStack(index, par1));
    ...
    private boolean isSuitableTarget(LivingEntity par1Mob, boolean par2) {
        ...
        if (par1Mob instanceof Pointysaurus) {
            return false;
        }
