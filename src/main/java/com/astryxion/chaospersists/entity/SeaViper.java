...
extends MonsterEntity {
    private static final DataParameter<Byte> ATTACKING = EntityDataManager.defineId(SeaViper.class, DataSerializers.BYTE);
    ...
    public SeaViper(EntityType<? extends SeaViper> type, World par1World) {
    ...
    public static AttributeModifierMap createAttributes() {
        return MonsterEntity.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, ChaosPersists.SeaViper_stats.health)
                .add(Attributes.MOVEMENT_SPEED, 0.35)
                .add(Attributes.ATTACK_DAMAGE, ChaosPersists.SeaViper_stats.attack)
                .build();
    }
    ...
    public boolean doHurtTarget(LivingEntity par1Entity) {
        ...
        if (super.doHurtTarget(par1Entity)) {
            if (par1Entity != null && par1Entity instanceof LivingEntity) {
                ...
                if (this.level.random.nextInt(2) == 1) {
                    ((LivingEntity)par1Entity).addEffect(new EffectInstance(Effects.POISON, var2 * 20, 0));
                }
            }
            return true;
        }
        ...
        if (this.level.random.nextInt(5) == 1) {
            ...
            if (e != null) {
                ...
                if (this.distanceToSqr((Entity)e) < (double)((4.5f + e.getBbWidth() / 2.0f) * (4.5f + e.getBbWidth() / 2.0f))) {
                    ...
                    this.getNavigation().moveTo((Entity)e, 1.5);
                }
            } else {
                this.setAttacking(0);
            }
    ...
    private boolean isSuitableTarget(LivingEntity par1Mob, boolean par2) {
        ...
        if (par1Mob instanceof SeaViper) {
            return false;
        }
    ...
    private LivingEntity findSomethingToAttack() {
        ...
        List var5 = this.level.getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(18.0, 4.0, 18.0));
    ...
    public boolean checkSpawnRules(net.minecraft.world.IWorldReader level, net.minecraft.entity.SpawnReason reason) {
        ...
        target = this.level.getNearestEntity(SeaViper.class, net.minecraft.entity.EntityPredicate.DEFAULT, this, this.getX(), this.getY(), this.getZ(), this.getBoundingBox().inflate(16.0, 5.0, 16.0));
        if (target != null) {
            return false;
        }
        return true;
