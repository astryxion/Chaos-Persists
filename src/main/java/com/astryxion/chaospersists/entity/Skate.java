...
public class Skate extends Monster {
    private static final EntityDataAccessor<Byte> ATTACKING =
            SynchedEntityData.defineId(Skate.class, EntityDataSerializers.BYTE);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, (double) ChaosPersists.Skate_stats.health)
                .add(Attributes.MOVEMENT_SPEED, (double) 0.25f)
                .add(Attributes.ATTACK_DAMAGE, (double) ChaosPersists.Skate_stats.attack)
                .add(Attributes.ARMOR, (double) ChaosPersists.Skate_stats.defense);
    }
    ...
    public int mygetMaxHealth() {
        return ChaosPersists.Skate_stats.health;
    }
    ...
    private LivingEntity findSomethingToAttack() {
        ...
        List<LivingEntity> var5 =
                this.level()
                        .getEntitiesOfClass(
                                LivingEntity.class, this.getBoundingBox().inflate(10.0, 4.0, 10.0));
    ...
    private int findBuddies() {
        List<Skate> var5 =
                this.level()
                        .getEntitiesOfClass(
                                Skate.class, this.getBoundingBox().inflate(16.0, 8.0, 16.0));
        return var5.size();
    }

    public static boolean checkSkateSpawnRules(
            EntityType<Skate> type,
        ...
        List<Skate> buddies =
                level.getLevel()
                        .getEntitiesOfClass(Skate.class, new AABB(pos).inflate(16.0, 8.0, 16.0));
        if (buddies.size() > 6) {
            return false;
        }
        return true;
