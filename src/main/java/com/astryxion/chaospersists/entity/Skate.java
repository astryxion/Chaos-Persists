...
extends MonsterEntity {
    private static final DataParameter<Byte> ATTACKING = EntityDataManager.defineId(Skate.class, DataSerializers.BYTE);
    ...
    public Skate(EntityType<? extends Skate> type, World par1World) {
    ...
    public static AttributeModifierMap createAttributes() {
        return MonsterEntity.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, ChaosPersists.Skate_stats.health)
                .add(Attributes.MOVEMENT_SPEED, 0.25)
                .add(Attributes.ATTACK_DAMAGE, ChaosPersists.Skate_stats.attack)
                .build();
    }
    ...
    public int getArmorValue() {
        return ChaosPersists.Skate_stats.defense;
    }
    ...
    protected net.minecraft.util.SoundEvent getDeathSound() {
        return com.astryxion.chaospersists.core.ChaosSounds.RATDEAD;
    }
    ...
    private int findBuddies() {
        List var5 = this.level.getEntitiesOfClass(Skate.class, this.getBoundingBox().inflate(16.0, 8.0, 16.0));
        return var5.size();
    }
