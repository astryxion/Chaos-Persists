...
extends TameableEntity {
    private static final DataParameter<Integer> I20 = EntityDataManager.defineId(ThePrinceAdult.class, DataSerializers.INT);
    private static final DataParameter<Integer> I21 = EntityDataManager.defineId(ThePrinceAdult.class, DataSerializers.INT);
    private static final DataParameter<Integer> I22 = EntityDataManager.defineId(ThePrinceAdult.class, DataSerializers.INT);
    private static final DataParameter<Integer> I23 = EntityDataManager.defineId(ThePrinceAdult.class, DataSerializers.INT);
    private static final DataParameter<Integer> I24 = EntityDataManager.defineId(ThePrinceAdult.class, DataSerializers.INT);
    private static final DataParameter<Integer> I25 = EntityDataManager.defineId(ThePrinceAdult.class, DataSerializers.INT);
    ...
    public ThePrinceAdult(EntityType<? extends ThePrinceAdult> type, World par1World) {
        ...
        this.goalSelector.addGoal(4, new LookAtGoal(this, LivingEntity.class, 20.0f));
    ...
    public ThePrinceAdult(World par1World, double par2, double par4, double par6) {
        this((EntityType<? extends ThePrinceAdult>)net.minecraftforge.registries.ForgeRegistries.ENTITIES.getValue(new net.minecraft.util.ResourceLocation("chaospersists", "the_young_adult_prince")), par1World);
    ...
    public void travel(Vector3d travelVector) {
        ...
        if (!this.getPassengers().isEmpty() && this.getControllingPassenger() instanceof LivingEntity) {
            ...
            if (riderJumping || ChaosPersists.flyup_keystate != 0) {
                com.astryxion.chaospersists.util.MyUtils.addDeltaMovement(this, 0.0, 0.075, 0.0);
    ...
    protected void jump() {
        ...
        com.astryxion.chaospersists.util.MyUtils.addDeltaMovement(this, 0.0, 0.35, 0.0);
    }
    ...
    protected net.minecraft.util.SoundEvent getAmbientSound() {
        ...
        if (this.getActivity() == 1 && !this.isOnGround() && this.getPassengers().isEmpty()) {
    ...
    public boolean doHurtTarget(LivingEntity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof LivingEntity) {
            ...
            par1Entity.hurt(DamageSource.mobAttack((LivingEntity)this), iskraken * 100.0f);
    ...
    public void customServerAiStep() {
        ...
        if (this.getActivity() == 0 && this.getPassengers().isEmpty() && this.level.getDifficulty() != Difficulty.PEACEFUL && this.isTame() && ChaosPersists.FullPowerKingEnable != 0) {
            ++this.growcounter;
            if (this.growcounter > 288000) {
                Entity ent = null;
                TheKing d = null;
                ent = ThePrinceAdult.spawnCreature((World)this.level, (String)"The King", (double)this.getX(), (double)this.getY(), (double)this.getZ());
                if (ent != null) {
                    d = (TheKing)ent;
                    d.setFree();
                    this.remove();
    ...
    public void fly_with_rider() {
        ...
        if (this.level.random.nextInt(5) == 1 && this.level.getDifficulty() != Difficulty.PEACEFUL) {
            ...
            if (e != null) {
                this.setAttacking(1);
                if (this.distanceToSqr((Entity)e) < (double)((10.0f + e.getBbWidth() / 2.0f) * (10.0f + e.getBbWidth() / 2.0f))) {
                    this.doHurtTarget((LivingEntity)e);
                } else if (this.distanceToSqr((Entity)e) < 625.0 && !this.isInWater() && this.getThePrinceAdultFire() != 0) {
    ...
    private LivingEntity findSomethingToAttack() {
        ...
        List var5 = this.level.getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(32.0, 20.0, 32.0));
    ...
    public void tick() {
        ...
        this.noPhysics = this.getActivity() != 0 && !this.getPassengers().isEmpty();
        ...
        if (this.getActivity() == 0 && this.isTame() && this.getOwner() != null && !this.isOrderedToSit() && this.distanceToSqr((Entity)(e = this.getOwner())) > 900.0) {
            this.setActivity(1);
        }
    ...
    private void fly_without_rider() {
        ...
        if (!toofar && this.flyaway == 0 && this.level.getDifficulty() != Difficulty.PEACEFUL && this.level.random.nextInt(6) == 1) {
            e = this.getTarget();
            if (e != null && !e.isAlive()) {
                this.setTarget(null);
                e = null;
            ...
            if (e != null) {
                if (this.isTame() && this.getHealth() / (float)this.mygetMaxHealth() < 0.25f) {
                    ...
                    if (this.distanceToSqr((Entity)e) < (double)((10.0f + e.getBbWidth() / 2.0f) * (10.0f + e.getBbWidth() / 2.0f))) {
                        ...
                        do_new = true;
                    } else if (this.distanceToSqr((Entity)e) < 600.0 && !this.isInWater() && this.getThePrinceAdultFire() != 0 && this.level.random.nextInt(2) == 1) {
                        this.shoot_something(e.getX(), e.getY(), e.getZ());
                    }
                }
            } else {
...
com.astryxion.chaospersists.util.MyUtils.addDeltaMovement(this, (Math.signum(var1) - this.getDeltaMovement().x) * 0.15 * speed_factor, (Math.signum(var3) - this.getDeltaMovement().y) * 0.21 * speed_factor, (Math.signum(var5) - this.getDeltaMovement().z) * 0.15 * speed_factor);
                ...
                if (!this.getPassengers().isEmpty()) {
                    ...
                    if (this.fireballticker == 0 && (pp.xxa < -0.001f || pp.xxa > 0.001f)) {
                        ...
                        if (this.which_attack == 0) {
                            ...
                            bf.setBig();
                            bf.setNotMe();
                            bf.setPos(cx, this.getY() + (yoff -= (double)((float)this.getHead1Ext() * 0.08f)), cz);
                        ...
                        if (this.which_attack == 1) {
                            cx = this.getX() - xzoff * Math.sin(Math.toRadians(this.yRot + 10.0f));
                            cz = this.getZ() + xzoff * Math.cos(Math.toRadians(this.yRot + 10.0f));
                            IceBall var2 = new IceBall(this.level, cx, this.getY() + (yoff -= (double)((float)this.getHead3Ext() * 0.08f)), cz);
                        ...
                        if (this.which_attack == 2) {
                            ...
                            lb.moveTo(cx, this.getY() + (yoff -= (double)((float)this.getHead2Ext() * 0.08f)), cz, pp.yRot + 90.0f, pp.xRot);
                    ...
                    if (!this.level.isClientSide && (list = this.level.getEntities((Entity)this, this.getBoundingBox().inflate(6.25, 10.0, 6.25))) != null && !list.isEmpty()) {
                        for (int l = 0; l < list.size(); ++l) {
                            listEntity = (Entity)list.get(l);
                            if (listEntity == (this.getPassengers().isEmpty() ? null : this.getPassengers().get(0)) || !listEntity.isAlive() || !listEntity.isPushable()) continue;
    ...
    public ActionResultType mobInteract(PlayerEntity par1PlayerEntityEntity, Hand hand) {
        ...
        if (var2 != null && var2.getItem() == Item.byBlock((Block)Blocks.DIAMOND_BLOCK) && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 36.0) {
            if (!this.level.isClientSide) {
        ...
        if (this.isTame()) {
            ...
            if (var2 == null && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 36.0) {
                if (!this.level.isClientSide) {
            ...
            if (var2 != null && var2.getItem() == Items.BEEF && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 36.0) {
                if (this.level.isClientSide) {
            ...
            if (var2 != null && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 36.0 && var2.isEdible()) {
                if (!this.level.isClientSide) {
            ...
            if (var2 != null && var2.getItem() == Item.byBlock((Block)Blocks.ICE) && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 36.0) {
                if (!this.level.isClientSide) {
                    this.level.broadcastEntityEvent(this, (byte)7);
            ...
            if (var2 != null && var2.getItem() == Items.FLINT_AND_STEEL && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 36.0) {
                if (!this.level.isClientSide) {
                    this.level.broadcastEntityEvent(this, (byte)7);
                    this.level.broadcastEntityEvent(this, (byte)6);
                    this.setThePrinceAdultFire(1);
            ...
            if (var2 != null && var2.getItem() == Items.DIAMOND && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 36.0 && !this.level.isClientSide) {
                Entity ent = null;
                ThePrinceTeen d = null;
                ent = ThePrinceAdult.spawnCreature((World)this.level, (String)"The Young Prince", (double)this.getX(), (double)this.getY(), (double)this.getZ());
                if (ent != null) {
                    d = (ThePrinceTeen)ent;
                    if (this.isTame()) {
                        d.setTame(true);
            ...
            if (this.isTame() && var2 != null && var2.getItem() == Items.NAME_TAG && par1PlayerEntityEntity.distanceToSqr((Entity)this) < 36.0 && this.isOwnedBy((LivingEntity)par1PlayerEntityEntity)) {
    ...
    public void addAdditionalSaveData(CompoundNBT par1CompoundNBT) {
        ...
        par1CompoundNBT.putInt("ThePrinceAdultAttacking", this.getAttacking());
        par1CompoundNBT.putInt("ThePrinceAdultActivity", this.getActivity());
        par1CompoundNBT.putInt("ThePrinceAdultFire", this.getThePrinceAdultFire());
        par1CompoundNBT.putInt("ThePrinceAdultGrow", this.growcounter);
    }

    public void readAdditionalSaveData(CompoundNBT par1CompoundNBT) {
        super.readAdditionalSaveData(par1CompoundNBT);
        this.setAttacking(par1CompoundNBT.getInt("ThePrinceAdultAttacking"));
        this.setActivity(par1CompoundNBT.getInt("ThePrinceAdultActivity"));
        this.setThePrinceAdultFire(par1CompoundNBT.getInt("ThePrinceAdultFire"));
        this.growcounter = par1CompoundNBT.getInt("ThePrinceAdultGrow");
    }
