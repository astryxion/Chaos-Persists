...
public class ThePrinceAdult extends TamableAnimal {
            ...
            this.targetSelector.addGoal(
                    ...
                    new NearestAttackableTargetGoal<>(
                        ...
                        public boolean canUse() {
                            return PetCombatHelper.canUseNearestHostileGoal(ThePrinceAdult.this)
                                    && super.canUse();
                        }
                    });
        }
    ...
    public boolean hurt(DamageSource par1DamageSource, float par2) {
        ...
        // 1.7.10 only ignored same-stage adults; isSuitableTarget rejects all royalty, so ignore
