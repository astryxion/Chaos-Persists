...
public class EmeraldSword extends SwordItem {
    ...
    public EmeraldSword(IItemTier tier) {
        this(tier, new Item.Properties().stacksTo(1).durability(1300));
    }

    public EmeraldSword(IItemTier tier, Item.Properties properties) {
        super(tier, (int)(15.0F - tier.getAttackDamageBonus()), -2.4F, properties);
