...
public class ExperienceSword extends SwordItem {
    ...
    public ExperienceSword(IItemTier tier) {
        this(tier, new Item.Properties().stacksTo(1).durability(1400));
    }

    public ExperienceSword(IItemTier tier, Item.Properties properties) {
