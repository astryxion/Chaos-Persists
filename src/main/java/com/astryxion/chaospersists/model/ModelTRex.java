...
public class ModelTRex extends EntityModel<TRex> {
    ...
    public ModelTRex(float f1) {
        ...
        this.Shape18.setPos(3.3f, -25.0f, -23.0f);
        ...
        this.Shape19.setPos(-4.0f, -24.0f, -23.0f);
        ...
        this.TailExtension.setPos(-1.0f, -19.0f, 59.0f);
        ...
        this.Spine1.setPos(-1.0f, -21.0f, 0.0f);
        ...
        this.Spine2.setPos(-0.5f, -21.0f, 6.0f);
        ...
        this.Spine3.setPos(-0.5f, -21.0f, 12.0f);
        ...
        this.Spine4.setPos(-0.5f, -24.0f, -9.0f);
        ...
        this.Spine5.setPos(-0.5f, -26.0f, -14.0f);
    ...
    public void renderToBuffer(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ...
        this.TailExtension.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
