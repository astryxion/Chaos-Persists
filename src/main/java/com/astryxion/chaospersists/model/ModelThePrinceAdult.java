...
public class ModelThePrinceAdult extends EntityModel<ThePrinceAdult> {
    ...
    @Override
    public void setupAnim(ThePrinceAdult k, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        float f = limbSwing;
        ...
        if (k.getAttacking() != 0) {
            ...
            if (k.getActivity() == 0 || k.isOnGround()) {
        ...
        } else if (!k.isOrderedToSit() && (k.getActivity() == 0 || k.isOnGround())) {
    ...
    public void renderToBuffer(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ...
        this.Lwing4.render(matrixStack, buffer, packedLight, packedOverlay, 0.75F, 0.75F, 0.75F, 0.55F);
        this.Lwing6.render(matrixStack, buffer, packedLight, packedOverlay, 0.75F, 0.75F, 0.75F, 0.55F);
        this.Lwing8.render(matrixStack, buffer, packedLight, packedOverlay, 0.75F, 0.75F, 0.75F, 0.55F);
        this.Lwing10.render(matrixStack, buffer, packedLight, packedOverlay, 0.75F, 0.75F, 0.75F, 0.55F);
        this.Rwing2.render(matrixStack, buffer, packedLight, packedOverlay, 0.75F, 0.75F, 0.75F, 0.55F);
        this.Rwing4.render(matrixStack, buffer, packedLight, packedOverlay, 0.75F, 0.75F, 0.75F, 0.55F);
        this.Rwing6.render(matrixStack, buffer, packedLight, packedOverlay, 0.75F, 0.75F, 0.75F, 0.55F);
        this.Rwing8.render(matrixStack, buffer, packedLight, packedOverlay, 0.75F, 0.75F, 0.75F, 0.55F);
        this.Rwing10.render(matrixStack, buffer, packedLight, packedOverlay, 0.75F, 0.75F, 0.75F, 0.55F);
    }
