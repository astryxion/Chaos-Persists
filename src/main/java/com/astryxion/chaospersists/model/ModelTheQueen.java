...
public class ModelTheQueen extends EntityModel<TheQueen> {
    private TheQueen chaosAnimEntity;
    ...
    public ModelTheQueen(float f1) {
        ...
        this.LFoot.setPos(53.0f, -52.0f, 36.0f);
        ...
        this.LLClaw1.setPos(66.0f, -2.0f, -7.0f);
        ...
        this.LRClaw1.setPos(38.0f, -2.0f, -7.0f);
        ...
        this.LLClaw2.setPos(66.0f, -2.0f, -7.0f);
        ...
        this.LRClaw2.setPos(38.0f, -2.0f, -7.0f);
        ...
        this.RThigh.setPos(-66.0f, -91.0f, 2.0f);
        ...
        this.RLClaw1.setPos(-38.0f, -2.0f, -7.0f);
        ...
        this.RRClaw1.setPos(-66.0f, -2.0f, -7.0f);
        ...
        this.RLClaw2.setPos(-38.0f, -2.0f, -7.0f);
        ...
        this.RRClaw2.setPos(-66.0f, -2.0f, -7.0f);
        ...
        this.NeckBone1.setPos(-2.0f, -123.0f, -79.0f);
        ...
        this.NeckBone2.setPos(27.0f, -123.0f, -79.0f);
        ...
        this.NeckBone3.setPos(-33.0f, -123.0f, -79.0f);
        ...
        this.PowerCube1.setPos(0.0f, -86.0f, -50.0f);
        ...
        this.Rib1.setPos(29.0f, -71.0f, -67.0f);
        ...
        this.Rib2.setPos(28.0f, -66.0f, -53.0f);
        ...
        this.Rib3.setPos(30.0f, -83.0f, -70.0f);
        ...
        this.Rib4.setPos(-29.0f, -71.0f, -67.0f);
        ...
        this.Rib5.setPos(-30.0f, -83.0f, -70.0f);
        ...
        this.Rib6.setPos(-28.0f, -66.0f, -53.0f);
        ...
        this.PowerCube2.setPos(0.0f, -86.0f, -50.0f);
        ...
        this.PowerCube3.setPos(0.0f, -86.0f, -50.0f);
    ...
    @Override
    public void setupAnim(TheQueen k, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        float f = limbSwing;
        ...
        this.PowerCube1.xRot += 0.03f;
        if ((double)this.PowerCube1.xRot > 3.141592653589793) {
            this.PowerCube1.xRot = (float)((double)this.PowerCube1.xRot - 6.283185307179586);
        }
        this.PowerCube2.xRot += 0.04f;
        if ((double)this.PowerCube2.xRot > 3.141592653589793) {
            this.PowerCube2.xRot = (float)((double)this.PowerCube2.xRot - 6.283185307179586);
        }
        this.PowerCube3.xRot += 0.05f;
        if ((double)this.PowerCube3.xRot > 3.141592653589793) {
            this.PowerCube3.xRot = (float)((double)this.PowerCube3.xRot - 6.283185307179586);
        }
        this.PowerCube1.yRot += 0.035f;
        if ((double)this.PowerCube1.yRot > 3.141592653589793) {
            this.PowerCube1.yRot = (float)((double)this.PowerCube1.yRot - 6.283185307179586);
        }
        this.PowerCube2.yRot += 0.046f;
        if ((double)this.PowerCube2.yRot > 3.141592653589793) {
            this.PowerCube2.yRot = (float)((double)this.PowerCube2.yRot - 6.283185307179586);
        }
        this.PowerCube3.yRot += 0.065f;
        if ((double)this.PowerCube3.yRot > 3.141592653589793) {
            this.PowerCube3.yRot = (float)((double)this.PowerCube3.yRot - 6.283185307179586);
        }
        this.PowerCube1.zRot += 0.05f;
        if ((double)this.PowerCube1.zRot > 3.141592653589793) {
            this.PowerCube1.zRot = (float)((double)this.PowerCube1.zRot - 6.283185307179586);
        }
        this.PowerCube2.zRot += 0.13f;
        if ((double)this.PowerCube2.zRot > 3.141592653589793) {
            this.PowerCube2.zRot = (float)((double)this.PowerCube2.zRot - 6.283185307179586);
        }
        this.PowerCube3.zRot += 0.03f;
        if ((double)this.PowerCube3.zRot > 3.141592653589793) {
            this.PowerCube3.zRot = (float)((double)this.PowerCube3.zRot - 6.283185307179586);
        }
    }

    @Override
    public void renderToBuffer(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        TheQueen k = this.chaosAnimEntity;
        this.LCClaw1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        ...
        this.NeckC1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        ...
        this.LLClaw1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LRClaw1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LCClaw2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LLClaw2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.TailSpike.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LRClaw2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LClawRear.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckL1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckR1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RThigh.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RUpperLeg.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RLowerLeg.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RFoot.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RClawRear.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RLClaw1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RCClaw1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RRClaw1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RLClaw2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RCClaw2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RRClaw2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckL2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckC2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckR2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckL3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckC3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckR3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckL4.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LHead1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LHead2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LHead3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        ...
        this.LTooth1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LTooth2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LTooth3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.LTooth4.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CHead1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CHead2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CHead3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CJaw1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CJaw2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CJaw3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CTooth1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CTooth2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CTooth3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.CTooth4.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RHead1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RHead2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RHead3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        ...
        this.RTooth1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RTooth2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RTooth3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.RTooth4.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        ...
        this.Lwing5.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Lwing7.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Lwing9.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        ...
        this.Rwing5.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Rwing7.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Rwing9.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.TailTip2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Ridge1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Ridge2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Ridge3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Ridge4.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Ridge5.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Ridge6.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckBone1.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckBone2.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.NeckBone3.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        ...
        this.Rib5.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        this.Rib6.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
        ...
        this.PowerCube1.render(matrixStack, buffer, fullBright, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
        if (k.getPower() > 350) {
            this.PowerCube2.render(matrixStack, buffer, fullBright, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
        }
        if (k.getPower() > 650) {
            this.PowerCube3.render(matrixStack, buffer, fullBright, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
        }
        GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
        GL11.glDisable((int)3042);
        this.LLEye.render(matrixStack, buffer, packedLight, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
        this.LREye.render(matrixStack, buffer, packedLight, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
        this.CLEye.render(matrixStack, buffer, packedLight, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
        this.CREye.render(matrixStack, buffer, packedLight, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
        this.RLEye.render(matrixStack, buffer, packedLight, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
        this.RREye.render(matrixStack, buffer, packedLight, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
                matrixStack.popPose();
    }
