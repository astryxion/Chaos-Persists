...
implements IItemRenderer {
    ...
    private static final ResourceLocation texture = new ResourceLocation("chaospersists", "textures/entity/berthatexture.png");
...
public /* varargs */ void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object ... data) {
    ...
    private void drawModel(MatrixStack matrixStack) {
        ...
        this.modelBertha.renderToBuffer(matrixStack, vertexBuilder, 15728880, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
