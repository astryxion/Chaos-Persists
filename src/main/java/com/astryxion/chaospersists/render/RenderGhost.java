...
extends LivingRenderer<Ghost, ModelGhost> {
    ...
    public RenderGhost(EntityRendererManager manager, ModelGhost par1Model, float par2, float par3) {
...
protected void applyScale(MatrixStack matrixStack) { matrixStack.scale(this.scale, this.scale, this.scale); }
    ...
    protected void scale(Ghost entity, MatrixStack matrixStack, float partialTick) { this.applyScale(matrixStack); }
