...
extends LivingRenderer<Molenoid, ModelMolenoid> {
    ...
    public RenderMolenoid(EntityRendererManager manager, ModelMolenoid par1Model, float par2, float par3) {
...
protected void applyScale(MatrixStack matrixStack) { matrixStack.scale(this.scale, this.scale, this.scale); }
    ...
    protected void scale(Molenoid entity, MatrixStack matrixStack, float partialTick) { this.applyScale(matrixStack); }
