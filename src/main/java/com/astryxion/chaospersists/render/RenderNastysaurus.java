...
extends LivingRenderer<Nastysaurus, ModelNastysaurus> {
    ...
    public RenderNastysaurus(EntityRendererManager manager, ModelNastysaurus par1Model, float par2, float par3) {
...
protected void applyScale(MatrixStack matrixStack) { matrixStack.scale(this.scale, this.scale, this.scale); }
    ...
    protected void scale(Nastysaurus entity, MatrixStack matrixStack, float partialTick) { this.applyScale(matrixStack); }
